...
> **Summary:** Across 6 open-source crawlers tested on 8 sites, MarkCrawl is the fastest (14.0 pages/sec), generates the fewest chunks (22,132 total, 2.1x fewer than crawlee), the lowest total RAG pipeline cost at every scale tested.
>
> **Where MarkCrawl is not first:**  Answer quality is 5th (4.30/5, scrapy+md leads at 4.41).   Retrieval Hit@5 is 6th (86% vs 91% for scrapy+md).
